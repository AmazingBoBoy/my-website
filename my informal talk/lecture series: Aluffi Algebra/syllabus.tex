...
\begin{enumerate}
    ...
    \item HW: reading (chapter 1, section 5) and (chapter 2 section 5). Do all exericses form ch1 section 5. Do 5.1, 5.2, 5.3, 5.4, 5.5, 5.9, 5.10 in chapter 2 section 5. 
    \item Exercise: find the free objects in the category of topological spaces. 
\end{enumerate}
\section{Day 6}

\begin{enumerate}
    \item Subgroups: categorical way, normal way. 
    \item $ab\inv \in H$ for all $a,b\in H$.
    \item Exmaples. 
\end{enumerate}
\end{document}